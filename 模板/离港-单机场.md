...
- https://github.com/airportchat/airport_cn/blob/main/Clash配置/Clash配置模板-单个机场

```
#####使用前必读######
#您好，这里离港专用Clash配置模板(单机场)，欢迎加入频道&群组和大佬们一起讨论：
...
#使用方法：
#第一步：将此界面所有代码复制到本地用文本编辑器(记事本/Notepad++等)打开，一般是Ctrl+H组合键调出替换窗口，将“离港机场名字01”全部替换成你的机场名字即可
#第二步:将68行中url换成你的机场clash订阅后导入clash即可！(特别注意：url的引号要保留)
