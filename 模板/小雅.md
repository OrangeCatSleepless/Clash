...
#  listen: :53
  ...
  nameserver-policy:
    "rule-set:Microsoft规则,Google规则,Apple规则,ChatGPT规则":
      - tls://8.8.8.8:853
      - tls://1.1.1.1:853
...
proxy-groups:
  ...
  - name: AU
    ...
    use:
      ...
      - 次选机场
      - 备用机场 
    filter: (?i)澳大利亚|悉尼|墨尔本|AU|ustralia|🇦🇺
  ...
  - name: IN
    ...
    use:
      ...
      - 次选机场
      - 备用机场 
    filter:  "^(?i).*(印度(?!尼西亚)|India|IN(?!donesia)|🇮🇳)"
  ...
  - name: US
    ...
    use:
      ...
      - 次选机场
      - 备用机场    
    filter: (?i)美国|加利福利亚|纽约|得克萨斯|佛罗里达|华盛顿|俄勒冈|US|🇺🇸
    proxies:
      - 最快US
...
#- RULE-SET,GoogleFCM,REJECT
 ...
 - RULE-SET,Apple_TV规则,🍎 Apple_TV
 - RULE-SET,Apple规则,🍎 Apple
 - RULE-SET,Youtube规则,💒 YOUTUBE
 - RULE-SET,Telegram规则,📠 Telegram
 - GEOSITE,category-entertainment,📺 Stream Media
 - RULE-SET,测速规则,🕞 测速
 - GEOSITE,category-games,🎮 游戏
 - GEOSITE,category-games@cn,DIRECT
 - GEOSITE,category-dev,🧰 开发网站
 - GEOSITE,facebook,🧑‍🤝‍🧑 海外社交聊天 
 - GEOSITE,instagram,🧑‍🤝‍🧑 海外社交聊天
 - GEOSITE,twitter,🧑‍🤝‍🧑 海外社交聊天
 - GEOSITE,vk,🧑‍🤝‍🧑 海外社交聊天
 - GEOSITE,linkedin,🧑‍🤝‍🧑 海外社交聊天 
 - GEOSITE,category-communication,🧑‍🤝‍🧑 海外社交聊天 
